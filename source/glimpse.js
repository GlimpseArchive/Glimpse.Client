    ...
    var providers = engine._providers,
        ...
        buildOnly = function(data, level, metadata) {
            ...
            if (engineUtil.includeHeading(metadata))
                html += '<thead><tr class="glimpse-row-header glimpse-row-header-' + level + '"><th class="glimpse-key">Key</th><th class="glimpse-cell-value">Value<a href="#" class="glimpse-toggle-all">[Expand All]</a></th></tr></thead>';
